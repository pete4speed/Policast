...
harris_states <- c("VT", "MA", "MD", "RI", "CT", "DC", "NJ", "IL", "DE", "NY", "CO", "CA", "WA", "OR", "NM", "HI", "VA", "NH", "MN", "ME")
trump_states <- c("IN", "KY", "WV", "OK", "AL", "TN", "MO", "MS", "SC", "FL", "AR", "TX", "ND", "ND", "WY", "LA", "NE", "OH", "UT", "MT", "IA", "KS", "ID", "NC", "GA", "PA", "WI", "AK")
